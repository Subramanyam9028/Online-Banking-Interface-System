...
import java.util.*;//karan hyat random package aste mnun used
...
public class Signup3 extends JFrame implements ActionListener{
	...
	Signup3(String formNo){
		...
		JLabel number = new JLabel("XXXX-XXXX-XXXX-8324");
...
//			long cardnumber = Math.abs((random.nextLong() % 90000000L)) + 5040936000000000L;	
			String cardnumber = "" + Math.abs((random.nextLong() % 90000000L) + 5040936000000000L);	//string mde karnyasathi "" hya sobt concate kel
			...
			try {
				if (accountType.equals("")) {
					...
					JOptionPane.showMessageDialog(null,"Account Type Is Required"); // he sgle validation ahet. he jr nsl enter kel tr data base mde data janarch nahi
				}
				else {
				...
				setVisible(false);
				new Deposit(pinnumber).setVisible(true);// itha tya class la bolavla karan ki account kadtana kahi tri amount deposit karav lagte
